...
CREATE TABLE movies_managed (title STRING, category STRING, length FLOAT, release_date DATE)
...
CREATE EXTERNAL TABLE actors_external (actor_id INT, name STRING, nationality STRING)
